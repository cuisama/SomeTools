...
namespace HjDictClient
{
    ...
    public class DbManager : IDisposable
    {
        ...
        /// <param name="DBName">PCS_DB</param>
        public DbManager(string hostName)
        {
            string dbName = Para.PCS_DBNAME;
            string dbUserId = Para.PCS_DBUSERID;
            string dbPassword = Para.PCS_DBPASSWORD;
        ...
        public DbManager()
        {
            string hostName = Para.PCS_DBHOSTNAME;
            string dbName = Para.PCS_DBNAME;
            string dbUserId = Para.PCS_DBUSERID;
            string dbPassword = Para.PCS_DBPASSWORD;
            Connect(hostName, dbName, dbUserId, dbPassword);
        ...
        private void OutputSQL(string sqlState, Dictionary<string, object> parameters)
        {
            ...
            //try
            //{
            //    string logFilePath = Para.LOG_PATH;
